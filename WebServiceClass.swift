    ...
    func jsonCallwithData(dicData: [AnyHashable: Any] , ClassUrl : String , completionHandler: @escaping (NSMutableDictionary?, Error?) -> Swift.Void)
    {
        ...
        let task = session.dataTask(with: request) { data, response, error in
            ...
            let jsonResult: NSDictionary? = try JSONSerialization.jsonObject(with: data!, options: JSONSerialization.ReadingOptions.mutableContainers) as? NSDictionary
                ...
                if(jsonResult?.value(forKey: "code") as! NSInteger == successCode)
                {
 ...
 //MARK: - internet connection request
    ...
    func showFailureMessage(error : NSError)  {
        ...
        if (error.localizedDescription.range(of: "The request timed out."))  != nil {
            CommonMethodsModel.showAlertwithTitle(strTitle: "Appname", message: "The request timed out, please verify your internet connection and try again.")
        }
        ...
        {
            CommonMethodsModel.showAlertwithTitle(strTitle: "Appname", message: "Unable to reach to the server, please try again after few minutes")
        }
        else if (error.localizedDescription.range(of: "The network connection was lost."))  != nil  {
            CommonMethodsModel.showAlertwithTitle(strTitle: "Appname", message: "The network connection was lost, please try again.")
        }
        else if (error.localizedDescription.range(of:"The Internet connection appears to be offline."))  != nil  {
            CommonMethodsModel.showAlertwithTitle(strTitle:"Appname", message: "The Internet connection appears to be offline.")
        }
            ...
            CommonMethodsModel.showAlertwithTitle(strTitle: "Appname", message: "Server error!")
        }
        else{
            CommonMethodsModel.showAlertwithTitle(strTitle: "Appname", message: "Unable to connect, please try again!")
        }
    }
